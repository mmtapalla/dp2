    ...
    def run_inference(self, camera_id, width, height, num_threads, enable_edgetpu):
        ...
        while cap.isOpened():
            ...
            if not success:
                ...
                engine.runAndWait()
                time.sleep(1)
                os.system("mpg321 -q -q audio/error_cam.mp3")
...
class ProgramProper:
    ...
    def on_greet():
        ...
        # gTTS("Object detector on! Auto Mode!").save("audio/boot-alt.mp3")
        time.sleep(1)
        os.system("mpg321 -q -q audio/boot-alt.mp3")
    ...
    def interaction(classes, cap):
        ...
        if ProgramProper.AUTO_MODE:
            ...
            if GPIO.input(BUTTON_PIN_2) == GPIO.LOW:
                ...
                time.sleep(1)
                os.system("mpg321 -q -q audio/manual.mp3")
            ...
            if GPIO.input(BUTTON_PIN_1) == GPIO.LOW:
                ...
                time.sleep(1)
                os.system("mpg321 -q -q audio/auto.mp3")
            if GPIO.input(BUTTON_PIN_2) == GPIO.LOW:
    ...
    def toggle_auto_interval():
        if ProgramProper.AUTO_INTERVAL == 10:
            ...
            time.sleep(1)
            os.system(f"mpg321 -q -q audio/auto_{ProgramProper.AUTO_INTERVAL}s-int.mp3")
    ...
    def toggle_max_objects():
        ...
        time.sleep(1)
        os.system(f"mpg321 -q -q audio/max_{MAX_OBJ}-det.mp3")
    ...
    def toggle_prob_threshold():
        ...
        if PROB_THRESHOLD == 25:
            ...
            time.sleep(1)
            os.system(f"mpg321 -q -q audio/prob_{PROB_THRESHOLD}.mp3")
    ...
    def shutdown():
        ...
        time.sleep(1)
        os.system("mpg321 -q -q audio/off-prompt.mp3")
        ...
        while True:
            if (GPIO.input(BUTTON_PIN_1) == GPIO.LOW):
                ...
                time.sleep(1)
                os.system("mpg321 -q -q audio/shut_cancelled.mp3")
                break
    ...
    def process_auto_mode(freq, current_time, cap):
        if bool(freq):
            if time.time() - ProgramProper.AUTO_COUNTER >= ProgramProper.AUTO_INTERVAL and bool(freq):
                ...
                time.sleep(1)
                os.system("mpg321 -q -q audio/detection.mp3")
                ...
                if ret:
                    ...
                    # time.sleep(1)
                    # os.system("mpg321 -q -q audio/capture_failed.mp3")
                    pass
    ...
    def process_manual_mode(freq, current_time, cap):
        if bool(freq):
            ...
            if ret:
                ...
                # time.sleep(1)
                # os.system("mpg321 -q -q audio/error_capture.mp3")
                pass
        else:
            print("No detections!")
            # gTTS("No detections!").save("audio/detection_none.mp3")
            time.sleep(1)
            os.system("mpg321 -q -q audio/detection_none.mp3")
